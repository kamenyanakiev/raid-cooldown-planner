...
export const SPELLS_ARRAY = Object.keys(SPELLS_DETAILS).map(key => ({key, name: SPELLS_DETAILS[key].name,
  icon: SPELLS_DETAILS[key].icon, spec: SPELLS_DETAILS[key].spec}));
